...
public class TodaySugerActivity extends BaseActivity {
    ...
    protected void initView(Bundle savedInstanceState) {
        onViewClicked();
        //刷新的设置
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(TodaySugerActivity.this);
        recyclerview.setLayoutManager(linearLayoutManager);
        recyclerview.addItemDecoration(new DividerItemDecoration(TodaySugerActivity.this,
    ...
    private void getPearls(int page, final boolean isBottom) //今日获取糖果
    {
        ...
        String key = (String) SPUtil.get(TodaySugerActivity.this, "key", "");
        HttpListener<GetPearlsBean> httpListener = new HttpListener<GetPearlsBean>() {
            ...
            public void onSuccess(GetPearlsBean getPearlsBean) {
                ...
                if (getPearlsAdapter == null) {
                    getPearlsAdapter = new GetPearlsAdapter(TodaySugerActivity.this, list);
        ...
        getPearls = sugerLoader.getPearls(Custom.APPID, 1, page, 10, key, httpListener);
    }
}
