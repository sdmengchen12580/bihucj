...
import com.aganyun.acode.http.content.bean.GetColumnsBean.DataBean.ResponseBean.RowsBean;
...
public class HomeBihuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<RowsBean> mList;
    private Context context;

    public HomeBihuAdapter(Context context, List<RowsBean> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ImgsViewHolder) {
            ...
            tv_time.setText(rowsBean.getProcessDate());
                ...
                public void onClick(View v) {
                    if (!ObjIsNull.ObjIsNull(clickItemCallback)) {
                        if (!ObjIsNull.isEmpty(rowsBean.getDetailH5())) {
                            clickItemCallback.clickBihuItem("币虎专栏",
                                    rowsBean.getDetailH5(),
                                    id,
                                    position,
                                    rowsBean.getTTitle().toString().trim());
                        }
                    }
                }
            });
    ...
    public interface ClickItemCallback {
        void clickBihuItem(String webTitle, String webUrl, String id, int po, String content);
    }

    public void setNewsOnItenClickCallBack(ClickItemCallback clickItemCallback) {
