...
import com.aganyun.acode.http.content.bean.GetExtraIdsBean.DataBean.ResponseBean.RowsBean;
...
public class HomeExtralAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<RowsBean> mList;
    private Context context;

    public HomeExtralAdapter(Context context, List<RowsBean> list) {
                ...
                public void onClick(View v) {
                    if (!ObjIsNull.ObjIsNull(clickItemCallback)) {
                        if (!ObjIsNull.isEmpty(rowsBean.getDetailH5())) {
                            clickItemCallback.clickExtral("号外详情",
    ...
    public interface ClickItemCallback {
        void clickExtral(String webTitle, String webUrl, String id, int position, String title);
    }
