...
import com.aganyun.acode.http.content.bean.GetPolicysBean.DataBean.ResponseBean.RowsBean;
...
public class HomePolicysAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomePolicysAdapter(Context context, List<RowsBean> list) {
                ...
                public void onClick(View v) {
                    if (!ObjIsNull.ObjIsNull(clickItemCallback)) {
                        if (!ObjIsNull.isEmpty(rowsBean.getDetailH5())) {
                            clickItemCallback.clickPolicy("政策详情",
    ...
    public interface ClickItemCallback {
        void clickPolicy(String webTitle, String webUrl, String id, int position, String title);
    }
