...
import com.aganyun.acode.http.content.bean.GetNewsBean.DataBean.ResponseBean.RowsBean;
...
public class  HomeNewsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeNewsAdapter(Context context, List<RowsBean> list) {
                ...
                public void onClick(View v) {
                    if (!ObjIsNull.ObjIsNull(clickItemCallback)) {
                        if (!ObjIsNull.isEmpty(rowsBean.getDetailH5())) {
                            clickItemCallback.clickNewsItem("资讯详情",
    ...
    public interface ClickItemCallback {
        void clickNewsItem(String content, String webUrl, String id, int po, String title);
    }
