...
public class CustomTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public CustomTextView(Context context, AttributeSet attrs) {
        ...
        textColor = a.getColor(R.styleable.customtxv_textColor, context.getResources().getColor(R.color.black));
        textSize = a.getDimension(R.styleable.customtxv_textSize, 16);
        paddingLeft = a.getDimension(R.styleable.customtxv_paddingLeft, 4);
        paddingRight = a.getDimension(R.styleable.customtxv_paddingRight, 4);
        a.recycle();
    ...
    public CustomTextView(Context context, float textSize, int textColor,
        ...
        paint1.setTextScaleX(1.5F);
        paintColor.setTextScaleX(1.5F);
    }
